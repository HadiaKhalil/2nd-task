...
const page = () => {
   ...
   <div className="md:max-w-[70%]  mx-auto md:px-0  md:py-0 max-md:w-[75%] relative">
    ...
    <h1 className="lg:text-5xl md:text-3xl  text-2xl  font-bold pt-24 max-w-[440px] max-lg:text-[25px] ">
     ...
     <div className="box mt-[-220px] ml-[100px] absolute max-lg:mt-[-133px] max-md:mt-[-150px]  max-sm:ml-[20px]" ></div>
       ...
       Crafting seamless digital experiences from front-end elegance to
       back-end robustness, I bring your web visions to life as a versatile  full-stack developer
         </p>
  ...
  <div className="md:w-1/2 w-full">
    <Image src="https://www.figma.com/file/X0rloxyNybSrpm7JLQhUs9/image/5cba7c99d44d14f0ea98422b409edc80ff394e58" alt="" className="w-full h-full" />
  </div>
